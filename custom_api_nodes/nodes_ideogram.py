...
class IdeogramV1(IO.ComfyNode):
    ...
    async def execute(
        ...
        #     provider="ideogram",
        #     auth_kwargs=kwargs,
        #     path=path  # Make sure 'path' variable exists
        # )
        # custom_path = transform_path_for_custom_api(path, provider="ideogram")
        #
        # Then modify the operation to use:
        #   - path=custom_path instead of path=path
        #   - api_base=custom_api_base
        #   - auth_kwargs=custom_auth_kwargs instead of auth_kwargs=kwargs
